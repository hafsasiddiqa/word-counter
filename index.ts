...
console.log(chalk.yellow(wordCounterPicture));
    ...
    function countWords(paragraph: string, separator: string, wordGoal?: number, activity?: string): number {
      ...
      inquirer
        ...
        .then((answers: { paragraph: any; separator: any; wordGoal: any; activity: any }) => {
          ...
          .then((answer: { startAgain: boolean }) => {
